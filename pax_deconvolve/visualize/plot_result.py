...
def _make_reconvolved_plot(ax, deconvolved):
    ax.plot(deconvolved.reconstruction_x, deconvolved.measured_y_, label='Measured')
    ax.plot(deconvolved.reconstruction_x, deconvolved.reconstruction_y_, label='Reconvolved')
